...
from problems.views import ProblemDetailView, UserSolutionEvaluationView
...
#    url(r'^$', ProblemListView.as_view(), name='problems_problem_list'),
    ...
    url(r'^evaluate/(?P<pk>\d+)/$', UserSolutionEvaluationView.as_view(),
        name='problems_usersolution_evaluation'),
