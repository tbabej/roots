...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSolution.corrected_solution'
        db.add_column(u'problems_usersolution', 'corrected_solution',
                      self.gf('base.models.ContentTypeRestrictedFileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSolution.corrected_solution'
        db.delete_column(u'problems_usersolution', 'corrected_solution')
