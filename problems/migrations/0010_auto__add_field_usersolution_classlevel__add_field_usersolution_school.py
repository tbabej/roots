...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSolution.classlevel'
        db.add_column(u'problems_usersolution', 'classlevel',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserSolution.school'
        db.add_column(u'problems_usersolution', 'school',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schools.School'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserSolution.school_class'
        db.add_column(u'problems_usersolution', 'school_class',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSolution.classlevel'
        db.delete_column(u'problems_usersolution', 'classlevel')

        # Deleting field 'UserSolution.school'
        db.delete_column(u'problems_usersolution', 'school_id')

        # Deleting field 'UserSolution.school_class'
        db.delete_column(u'problems_usersolution', 'school_class')
