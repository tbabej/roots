...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProblemSeverity.competition'
        db.add_column(u'problems_problemseverity', 'competition',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['competitions.Competition']),
                      keep_default=False)

        # Adding field 'ProblemCategory.competition'
        db.add_column(u'problems_problemcategory', 'competition',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['competitions.Competition']),
                      keep_default=False)

        # Adding field 'Problem.result'
        db.add_column(u'problems_problem', 'result',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProblemSeverity.competition'
        db.delete_column(u'problems_problemseverity', 'competition_id')

        # Deleting field 'ProblemCategory.competition'
        db.delete_column(u'problems_problemcategory', 'competition_id')

        # Deleting field 'Problem.result'
        db.delete_column(u'problems_problem', 'result')
    ...
    models = {
        ...
        u'problems.usersolution': {
            ...
            'solution': ('base.models.ContentTypeRestrictedFileField', [], {'max_length': '100'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }
