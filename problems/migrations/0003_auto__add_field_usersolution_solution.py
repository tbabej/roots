...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSolution.solution'
        db.add_column(u'problems_usersolution', 'solution',
                      self.gf('django.db.models.fields.files.FileField')(default='nofile', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSolution.solution'
        db.delete_column(u'problems_usersolution', 'solution')
