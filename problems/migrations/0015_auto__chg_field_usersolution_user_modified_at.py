...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserSolution.user_modified_at'
        db.alter_column(u'problems_usersolution', 'user_modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 10, 20, 0, 0)))

    def backwards(self, orm):

        # Changing field 'UserSolution.user_modified_at'
        db.alter_column(u'problems_usersolution', 'user_modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))
