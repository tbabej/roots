...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'problems_problem', 'source',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Problem.image'
        db.add_column(u'problems_problem', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Problem.additional_files'
        db.add_column(u'problems_problem', 'additional_files',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'problems_problem', 'source')

        # Deleting field 'Problem.image'
        db.delete_column(u'problems_problem', 'image')

        # Deleting field 'Problem.additional_files'
        db.delete_column(u'problems_problem', 'additional_files')
