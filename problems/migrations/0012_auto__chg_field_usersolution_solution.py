...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserSolution.solution'
        db.alter_column(u'problems_usersolution', 'solution', self.gf('base.models.ContentTypeRestrictedFileField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserSolution.solution'
        raise RuntimeError("Cannot reverse this migration. 'UserSolution.solution' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'UserSolution.solution'
        db.alter_column(u'problems_usersolution', 'solution', self.gf('base.models.ContentTypeRestrictedFileField')(max_length=100))
