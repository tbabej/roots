...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Leaflet', fields ['competition', 'year', 'issue']
        db.create_unique(u'leaflets_leaflet', ['competition_id', 'year', 'issue'])


    def backwards(self, orm):
        # Removing unique constraint on 'Leaflet', fields ['competition', 'year', 'issue']
        db.delete_unique(u'leaflets_leaflet', ['competition_id', 'year', 'issue'])
