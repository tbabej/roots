...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Competition', fields ['name']
        db.create_unique(u'competitions_competition', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Competition', fields ['name']
        db.delete_unique(u'competitions_competition', ['name'])
