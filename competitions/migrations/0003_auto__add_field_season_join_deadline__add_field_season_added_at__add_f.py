...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Season.join_deadline'
        db.add_column(u'competitions_season', 'join_deadline',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Season.added_at'
        db.add_column(u'competitions_season', 'added_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 15, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Season.modified_at'
        db.add_column(u'competitions_season', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 15, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Season.added_by'
        db.add_column(u'competitions_season', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='seasons_created', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Season.modified_by'
        db.add_column(u'competitions_season', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='seasons_modified', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Competition.added_at'
        db.add_column(u'competitions_competition', 'added_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 15, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Competition.modified_at'
        db.add_column(u'competitions_competition', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 15, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Competition.added_by'
        db.add_column(u'competitions_competition', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='competitions_created', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Competition.modified_by'
        db.add_column(u'competitions_competition', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='competitions_modified', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'CompetitionUserRegistration.timestamp'
        db.delete_column(u'competitions_competitionuserregistration', 'timestamp')

        # Adding field 'CompetitionUserRegistration.added_at'
        db.add_column(u'competitions_competitionuserregistration', 'added_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 15, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'CompetitionUserRegistration.modified_at'
        db.add_column(u'competitions_competitionuserregistration', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 15, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'CompetitionUserRegistration.added_by'
        db.add_column(u'competitions_competitionuserregistration', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user registrations_created', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'CompetitionUserRegistration.modified_by'
        db.add_column(u'competitions_competitionuserregistration', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user registrations_modified', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Series.added_at'
        db.add_column(u'competitions_series', 'added_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 15, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Series.modified_at'
        db.add_column(u'competitions_series', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 15, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Series.added_by'
        db.add_column(u'competitions_series', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='series_created', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Series.modified_by'
        db.add_column(u'competitions_series', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='series_modified', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'CompetitionOrgRegistration.timestamp'
        db.delete_column(u'competitions_competitionorgregistration', 'timestamp')

        # Adding field 'CompetitionOrgRegistration.added_at'
        db.add_column(u'competitions_competitionorgregistration', 'added_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 15, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'CompetitionOrgRegistration.modified_at'
        db.add_column(u'competitions_competitionorgregistration', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 15, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'CompetitionOrgRegistration.added_by'
        db.add_column(u'competitions_competitionorgregistration', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='organizer registration_created', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'CompetitionOrgRegistration.modified_by'
        db.add_column(u'competitions_competitionorgregistration', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='organizer registration_modified', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Season.join_deadline'
        db.delete_column(u'competitions_season', 'join_deadline')

        # Deleting field 'Season.added_at'
        db.delete_column(u'competitions_season', 'added_at')

        # Deleting field 'Season.modified_at'
        db.delete_column(u'competitions_season', 'modified_at')

        # Deleting field 'Season.added_by'
        db.delete_column(u'competitions_season', 'added_by_id')

        # Deleting field 'Season.modified_by'
        db.delete_column(u'competitions_season', 'modified_by_id')

        # Deleting field 'Competition.added_at'
        db.delete_column(u'competitions_competition', 'added_at')

        # Deleting field 'Competition.modified_at'
        db.delete_column(u'competitions_competition', 'modified_at')

        # Deleting field 'Competition.added_by'
        db.delete_column(u'competitions_competition', 'added_by_id')

        # Deleting field 'Competition.modified_by'
        db.delete_column(u'competitions_competition', 'modified_by_id')


        # User chose to not deal with backwards NULL issues for 'CompetitionUserRegistration.timestamp'
        raise RuntimeError("Cannot reverse this migration. 'CompetitionUserRegistration.timestamp' and its values cannot be restored.")
        # Deleting field 'CompetitionUserRegistration.added_at'
        db.delete_column(u'competitions_competitionuserregistration', 'added_at')

        # Deleting field 'CompetitionUserRegistration.modified_at'
        db.delete_column(u'competitions_competitionuserregistration', 'modified_at')

        # Deleting field 'CompetitionUserRegistration.added_by'
        db.delete_column(u'competitions_competitionuserregistration', 'added_by_id')

        # Deleting field 'CompetitionUserRegistration.modified_by'
        db.delete_column(u'competitions_competitionuserregistration', 'modified_by_id')

        # Deleting field 'Series.added_at'
        db.delete_column(u'competitions_series', 'added_at')

        # Deleting field 'Series.modified_at'
        db.delete_column(u'competitions_series', 'modified_at')

        # Deleting field 'Series.added_by'
        db.delete_column(u'competitions_series', 'added_by_id')

        # Deleting field 'Series.modified_by'
        db.delete_column(u'competitions_series', 'modified_by_id')


        # User chose to not deal with backwards NULL issues for 'CompetitionOrgRegistration.timestamp'
        raise RuntimeError("Cannot reverse this migration. 'CompetitionOrgRegistration.timestamp' and its values cannot be restored.")
        # Deleting field 'CompetitionOrgRegistration.added_at'
        db.delete_column(u'competitions_competitionorgregistration', 'added_at')

        # Deleting field 'CompetitionOrgRegistration.modified_at'
        db.delete_column(u'competitions_competitionorgregistration', 'modified_at')

        # Deleting field 'CompetitionOrgRegistration.added_by'
        db.delete_column(u'competitions_competitionorgregistration', 'added_by_id')

        # Deleting field 'CompetitionOrgRegistration.modified_by'
        db.delete_column(u'competitions_competitionorgregistration', 'modified_by_id')
