...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Season.sum_method'
        db.add_column(u'competitions_season', 'sum_method',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Series.sum_method'
        db.add_column(u'competitions_series', 'sum_method',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Season.sum_method'
        db.delete_column(u'competitions_season', 'sum_method')

        # Deleting field 'Series.sum_method'
        db.delete_column(u'competitions_series', 'sum_method')
