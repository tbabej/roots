...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'competitions_season', 'start',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 5, 4, 0, 0)),
                      keep_default=False)

        # Adding field 'Season.end'
        db.add_column(u'competitions_season', 'end',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 5, 4, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'competitions_season', 'start')

        # Deleting field 'Season.end'
        db.delete_column(u'competitions_season', 'end')
